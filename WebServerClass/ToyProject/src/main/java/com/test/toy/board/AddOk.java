...
public class AddOk extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(reply.equals("")) {
			...
			int previousThread = (int)Math.floor((parentThread - 1)/1000) * 1000; //이전 새글의 thread
		...
		try {
			...
			//[{"value":"aaa"},{"value":"bbbb"}]
			
			for(Object obj : list) {
				//System.out.println(obj);
				//System.out.println(((JSONObject)obj).get("value")); //aaa
