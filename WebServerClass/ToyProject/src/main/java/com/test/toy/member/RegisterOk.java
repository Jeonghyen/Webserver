...
public class RegisterOk extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//C:\class\server\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\ToyProject\pic
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/member/registerok.jsp");
